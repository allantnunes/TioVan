...
export default class Tabela extends Component {
    ...
    render() {
        return (
            <>
                <button type="button" className="btn btn-warning btn-sm" data-toggle="modal" data-target="#modalKid">Listar</button>

                <div className="modal fade text-left" id="modalKid" tabIndex="-1" role="dialog" aria-labelledby="modalKidLabel" aria-hidden="true" style={{ marginTop: '60px' }}>
